"""Colorful bounce
Outline:
This activity, "Colorful Bounce," involves a moving rectangle (sprite) that bounces off the window edges. 
Each bounce changes its color and the window's background color, 
